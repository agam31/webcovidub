            ...
            <div class="row" style="margin-bottom: 30px;">
                <div class="col-md-6">
                    <div class="card card-no-border" style="width: 300px; margin: 0px auto; background: none;">
                        <img class="card-img-top" src="/webcovidub/assets/images/selfassessment.png" alt="Card image cap" style="width: 200px;
    margin: 0px auto;">
                ...
                <div class="col-md-6">
                    <div class="card card-no-border" style="width:300px; margin: 0px auto; background: none;">
                        <img class="card-img-top" src="/webcovidub/assets/images/coronadetector.png" alt="Card image cap" style="width: 200px;
    margin: 0px auto;">
                        <div class="card-body text-center">
            ...
            <div class="row" style="margin-bottom: 30px;">
                <div class="col-md-6">
                    <div class="card card-no-border" style="width: 300px; margin: 0px auto; background: none;">
                        <img class="card-img-top" src="/webcovidub/assets/images/penapisanub.png" alt="Card image cap" style="width: 200px;
    margin: 0px auto;">
                        <div class="card-body text-center">
                ...
                <div class="col-md-6">
                    <div class="card card-no-border" style="width:300px; margin: 0px auto; background: none;">
                        <img class="card-img-top" src="/webcovidub/assets/images/penapisanmhs.png" alt="Card image cap" style="width: 200px;
    margin: 0px auto;">
                        <div class="card-body text-center">
