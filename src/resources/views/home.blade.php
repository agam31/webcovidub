...
<div class="body-wrap">
    ...
    width: 105px;
">
                        <a href=""><img src="/webcovidub/assets/images/ri.png"></a>
                    </div>
                </div>
    ...
    width: 79px;
">
                        <a href=""><img src="/webcovidub/assets/images/jatim.png"></a>
                    </div>
                </div>
                <div class="col-md-5th-1 ">
                    <div class="image-icon-wrapper" style="
    width: 100px;
">
                        <a href=""><img src="/webcovidub/assets/images/malang.png"></a>
                    </div>
                </div>
                <div class="col-md-5th-1 ">
                    <div class="image-icon-wrapper" style="
    width: 200px;
">
                        <a href=""><img src="/webcovidub/assets/images/kemenkes.png"></a>
                    </div>
                </div>
                <div class="col-md-5th-1 ">
                    <div class="image-icon-wrapper" style="
    width: 105px;
">
                        <a href=""><img src="/webcovidub/assets/images/bnpb.png"></a>
                    </div>
                </div>
            </div>
        </div>
