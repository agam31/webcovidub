        ...
        <div class="container-fluid header-container container-default">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0" id="leftmenu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#"> Tentang Covid-19 </a>
                    </li>
                    <li class="nav-item">
                ...
                <button type="button" class="btn btn-outline-info btn-sm login-btn"> Login </button>
            ...
            <div class="row">
                <div class="col-md-4 offset-md-4">
                    <ul class="nav nav-pills nav-fill" id="data-covid-nav">
                        <li class="nav-item">
                            <a class="nav-link active" href="#">Jawa Timur</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#">Kota Malang</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<script type="text/javascript" src="/assets/bootstrap-4.4.1-dist/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
